            ...
            works.map((work,index)=> (
                        ...
                        <div key={index} className="work-section--items">
                            <div className="work-author--details">
                                ...
                                {work.isCompleted ?<div className="work-author--github"><LuGithub/><span className="github">look at the code</span></div> : <div className="loader-tooltip-container"><span className="loader-tooltip">still in work</span><div className="loader"></div></div> }
                            </div>
